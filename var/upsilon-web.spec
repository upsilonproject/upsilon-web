...
%if "%{?dist}" == "el7scl"
Requires: upsilon-database-sql httpd24-httpd rh-php56-php rh-php56-php-pdo rh-php56-php-mysqlnd rh-php56-php-mbstring rh-php56-php-bcmath rh-php56-php-xml
%else
